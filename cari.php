...
?>
      ...
      <input class="form-control mr-sm-2" type="search" name="keyword" placeholder="Search" value="<?=$key?>" aria-label="Search">
    ...
    <div class="container">
      <div class="row mb-4">
        <div class="col text-center">
          <h2>Hasil untuk pencarian : <?=$key?></h2>
        </div>
      </div>
      <div class="row">
      <?php 
			$data = mysqli_query($koneksi,"SELECT * FROM 05_barang WHERE (nama like '%$key%' OR deskripsi like '%$key%') AND stok !=0");
